...
Although all of these linkages satisfactorily perform the input task with any defect, linkages except Fig.~\ref{knnSol4}, \ref{knnSol5}, \ref{knnSol6} are suitable for the task considering the pivot locations.
...
\begin{figure}
\centering
\includegraphics[width=240pt]{figure/sol8.eps}
...
\begin{figure}
\centering
\includegraphics[width=240pt]{figure/sol9.eps}
  \caption{Ninth Linkage in the table~\ref{knnLinkageData} and its resultant motion.}
\label{knnSol9}
\end{figure}
